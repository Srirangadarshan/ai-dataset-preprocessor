...
RESPOND WITH ONLY THIS JSON FORMAT (no other text):
{
    ...
    "metrics": {
        "accuracy": <number between 0.7 and 0.95 for classification, null for regression>,
        "precision": <number between 0.7 and 0.95 for classification, null for regression>,
        "recall": <number between 0.7 and 0.95 for classification, null for regression>,
        "f1Score": <number between 0.7 and 0.95 for classification, null for regression>,
        "specificity": <number between 0.7 and 0.95 for classification, null for regression>,
        "sensitivity": <number between 0.7 and 0.95 for classification, null for regression>,
        "auc_roc": <number between 0.7 and 0.98 for classification, null for regression>,
        "logLoss": <number between 0.1 and 0.5 for classification, null for regression>,
        ...
        "mape": <number between 5 and 25 for regression as percentage, null for classification>,
        "r2Score": <number between 0.6 and 0.95 for regression, null for classification>,
        "adjustedR2": <number slightly less than r2Score for regression, null for classification>,
        "crossValScore": <number between 0.65 and 0.92>,
        "crossValStd": <number between 0.01 and 0.05>,
        "trainingTime": "<time in seconds like 0.45s>",
        "predictionTime": "<time in milliseconds like 2.3ms>"
    },
